...
class logRegL2():
    ...
    def fit(self, X, y):
        ...
        self.w, _ = findMin.findMin(self.funObj, np.zeros(
            d), self.maxEvals, X, y, verbose=self.verbose)
...
class kernelLogRegL2():
    ...
    def fit(self, X, y):
        ...
        self.u, _ = findMin.findMin(self.funObj, np.zeros(
            n), self.maxEvals, K, y, verbose=self.verbose)
